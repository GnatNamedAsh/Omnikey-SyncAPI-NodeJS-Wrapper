...
__declspec(dllexport) unsigned long SecureModeInitSession(SCARDHANDLE hCard,
							unsigned char *	pbKey,
...
// return predefined status
__declspec(dllexport) unsigned long SecureModeCloseSession(SCARDHANDLE hCard);
...
//					
// return predefined status
__declspec(dllexport) unsigned long SecureModeTransmit(SCARDHANDLE hCard,
